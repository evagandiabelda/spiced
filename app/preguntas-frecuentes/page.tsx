...
export default async function PerfilPage() {
    ...
    const triggerClassname = "pb-6 font-inter font-bold text-[var(--gris4)] px-4 rounded-xl bg-white dark:bg-[var(--gris4)] shadow-sm";
    ...
    return (
        <div className="w-full flex flex-col items-center mobile:gap-12 tablet:gap-0 px-col1 pt-[3rem] pb-32">
            ...
            <div className='w-full flex flex-col items-center gap-10 mobile:px-col1 tablet:px-col1 pt-12'>
                <Accordion type="single" collapsible className="w-full">

                    <AccordionItem value="item-1" className="mb-4">
                        <AccordionTrigger className={triggerClassname}>1. ¿Cómo puedo registrarme en Spiced y qué información es necesaria?</AccordionTrigger>
                    ...
                    <AccordionItem value="item-2" className="mb-4">
                        <AccordionTrigger className={triggerClassname}>2. ¿Qué son los "Spices" y cómo puedo elegirlos?</AccordionTrigger>
                        <AccordionContent className="p-6">
                            <p>Los "Spices" son las condiciones o trastornos psicológicos que te afectan (si eres usuario estándar) o en los que te especializas profesionalmente (si eres usuario experto). Puedes elegir tus Spices durante el proceso de registro o desde tu perfil en cualquier momento.</p>
                        </AccordionContent>
                    </AccordionItem>

                    <AccordionItem value="item-3" className="mb-4">
                        <AccordionTrigger className={triggerClassname}>3. ¿Cómo funciona el sistema de verificación para Usuarios Expertos?</AccordionTrigger>
                        <AccordionContent className="p-6">
                    ...
                    <AccordionItem value="item-4" className="mb-4">
                        <AccordionTrigger className={triggerClassname}>4. ¿Qué tipo de contenido puedo compartir en Spiced?</AccordionTrigger>
                        <AccordionContent className="p-6">
                    ...
                    <AccordionItem value="item-5" className="mb-4">
                        <AccordionTrigger className={triggerClassname}>5. ¿Cómo puedo buscar y filtrar contenido en Spiced?</AccordionTrigger>
                        <AccordionContent className="p-6">
                    ...
                    <AccordionItem value="item-6" className="mb-4">
                        <AccordionTrigger className={triggerClassname}>6. ¿Cómo puedo interactuar con otros usuarios en Spiced?</AccordionTrigger>
                        <AccordionContent className="p-6">
                            <p>Puedes interactuar siguiendo a otros usuarios, guardando sus Shares, comentando en ellos, o enviándoles una "Pingüinada" como gesto de afecto. No se permiten mensajes privados para fomentar una interacción abierta y transparente en la comunidad.</p>
                        </AccordionContent>
                    </AccordionItem>

                    <AccordionItem value="item-7" className="mb-4">
                        <AccordionTrigger className={triggerClassname}>7. ¿Cómo se manejan las denuncias de contenido inapropiado?</AccordionTrigger>
                        <AccordionContent className="p-6">
                    ...
                    <AccordionItem value="item-8" className="mb-4">
                        <AccordionTrigger className={triggerClassname}>8. ¿Cómo puedo obtener ayuda en situaciones de crisis?</AccordionTrigger>
                        <AccordionContent className="p-6">
