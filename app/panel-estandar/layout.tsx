...
export default function PanelEstandarLayout({
    ...
    return (
        <>
            ...
            <div className='w-full flex mobile:flex-col tablet:flex-row gap-0 mobile:justify-start tablet:justify-between align-start pt-[30px] tablet:pb-[40px] dark:hidden fondo-degradado1'>
                {/* CAJA SIDEBAR: */}
