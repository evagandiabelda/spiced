    ...
    return (
        <>
            ...
            <div className="w-full flex mobile:flex-col tablet:flex-row gap-0 mobile:justify-start tablet:justify-between align-start pt-[30px] pb-0 hidden dark:flex bg-[var(--gris4)]">
                ...
                {/* CAJA PRINCIPAL */}
                <section className="flex flex-col w-full h-full mobile:px-col1 tablet:px-[4rem] py-[4rem] pb-[6rem] rounded-t-[28px] tablet:rounded-t-none tablet:rounded-tl-[28px] bg-[var(--gris5)]">
                    {children}
                </section>
            </div>
        </>
