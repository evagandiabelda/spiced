    ...
    return (
        <div className='w-full flex mobile:flex-col tablet:flex-row gap-0 mobile:justify-start tablet:justify-between align-start'>
            ...
            <section className='dark h-full mobile:w-full tablet:w-fit laptop:w-full laptop:max-w-col3'>
                <div className="bg-[url('/imgs/IMG-Fondo-Aside-Login.webp')] bg-cover bg-center flex flex-col items-center justify-center gap-16 w-full h-full p-8">
                    ...
                    <div className="flex flex-col items-center gap-6 w-full">
                        ...
                        <Boton texto="Regístrate" enlace="#" tamano="grande" jerarquia="secundario" customColor="white" />
                    </div>
                </div>
            </section>
