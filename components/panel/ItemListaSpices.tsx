...
export default function ItemListaSpices({ id, nombre, onEdit, onDelete }: ItemProps) {
    ...
    return (
        <li className="w-full flex mobile:flex-col tablet:flex-row justify-between mobile:items-end tablet:items-center mobile:gap-4 tablet:gap-12 px-4 py-6 border-b border-b-[var(--gris2)] dark:border-b-[var(--gris4)]">
