...
export default function ThemeToggle() {
    ...
    if (theme === "light") {
        return (
            <>
                {/* Grande: */}
                <div onClick={toggleTheme} className='mobile:hidden laptop:block rounded-full px-[7px] pt-[4px] pb-[5px] bg-[var(--gris4)] sombra-interior-dark cursor-pointer'>
    ...
    if (theme === "dark") {
        return (
            <>
                {/* Grande: */}
                <div onClick={toggleTheme} className='mobile:hidden laptop:block rounded-full px-[7px] pt-[4px] pb-[5px] bg-[var(--gris3)] sombra-interior-light dark:border-2 dark:border-[var(--gris3)] cursor-pointer'>
                    <div id='opacidad' className='flex flex-row justify-between items-center pt-[2px] opacity-50 hover:opacity-100 transition ease duration-500'>
                        <div className='px-2'>
