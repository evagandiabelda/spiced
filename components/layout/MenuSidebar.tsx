            ...
            <nav className="w-full flex-col justify-start align-start gap-2">
                <a href="/panel-estandar" className="w-full">
                    <div className="flex flex-row items-center w-full gap-5 p-4 rounded-xl hover:bg-[--gris1] hover:bg-white/20">
                        ...
                        <p className="font-bold mb-0 tablet:hidden laptop:block">Inicio</p>
                    </div>
                </a>
                ...
                <a href="/panel-estandar/nuevo-share">
                    <div className="flex flex-row items-center w-full gap-5 p-4 rounded-xl hover:bg-[--gris1] hover:bg-white/20">
                        ...
                        <p className="font-bold mb-0 tablet:hidden laptop:block">Nuevo Share</p>
                    </div>
                </a>
                ...
                <a href="/panel-estandar/tus-shares">
                    <div className="flex flex-row items-center w-full gap-5 p-4 rounded-xl hover:bg-[--gris1] hover:bg-white/20">
                        ...
                        <p className="font-bold mb-0 tablet:hidden laptop:block">Tus Shares</p>
                    </div>
                </a>
                ...
                <a href="/panel-estandar/shares-guardados" className="w-full">
                    <div className="flex flex-row items-center w-full gap-5 p-4 rounded-xl hover:bg-[--gris1] hover:bg-white/20">
                        ...
                        <p className="font-bold mb-0 tablet:hidden laptop:block">Shares guardados</p>
                    </div>
                </a>
                ...
                <a href="/panel-estandar/insignias">
                    <div className="flex flex-row items-center w-full gap-5 p-4 rounded-xl hover:bg-[--gris1] hover:bg-white/20">
                        ...
                        <p className="font-bold mb-0 tablet:hidden laptop:block">Insignias</p>
                    </div>
                </a>
                ...
                <a href="/panel-estandar/configuracion">
                    <div className="flex flex-row items-center w-full gap-5 p-4 rounded-xl hover:bg-[--gris1] hover:bg-white/20">
                        ...
                        <p className="font-bold mb-0 tablet:hidden laptop:block">Configuración</p>
                    </div>
                </a>
            </nav>
        );
            ...
            <nav className="w-full flex-col justify-start align-start gap-2">
                ...
                <a href="/panel-experto/sesiones">
                    <div className="flex flex-row items-center w-full gap-5 p-4 rounded-xl hover:bg-[--gris1] hover:bg-white/20">
                        ...
                        <p className="font-bold mb-0 tablet:hidden laptop:block">Sesiones</p>
                    </div>
                </a>
                ...
                <a href="/panel-experto/verificaciones">
                    <div className="flex flex-row items-center w-full gap-5 p-4 rounded-xl hover:bg-[--gris1] hover:bg-white/20">
                        ...
                        <p className="font-bold mb-0 tablet:hidden laptop:block">Verificaciones</p>
                    </div>
                </a>
